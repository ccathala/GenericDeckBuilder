...
```java
// ❌ AVANT: Requête native PostgreSQL vulnérable
@Query(value = """
    SELECT * FROM card c 
    WHERE c.game_id = :gameId
    ORDER BY CASE COALESCE(c.properties::json->>'element', 'Unknown')...
    """, nativeQuery = true)

// ✅ APRÈS: Requête JPQL sécurisée
@Query("""
...
**Bénéfices :**
- ✅ Paramètres automatiquement échappés par Spring Data JPA
- ✅ Protection contre les injections SQL
- ✅ Maintien de la logique de tri complexe
