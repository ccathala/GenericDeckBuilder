...
('eclair d inspiration', E'Draw 1 card.Draw 1 additional card for each Inspiration component you control.', '', 'en', 'Flash Of Inspiration');
...
('rituel supraconducteur', E'You become a Mage Noir.Damage from spells you activate during the opponent''s turn is increased by 1. During your turn, your spells cannot inflict more than 2 damage at once.', '', 'en', 'Superconductor Ritual');
...
(card_id, description, image_url, locale, "name")
VALUES
('souffle', E'Prenez jusqu''à 2 Mana Air dans l''Ether Disponible.', 'https://magenoir.com/cards/FR/Air/Souffle-de-flammes.png', 'fr', 'Souffle'),
('souffle', E'Take up to 2 Air Mana from the Available Ether.', 'https://magenoir.com/cards/EN/air/Breath-of-flames.png', 'en', 'Breath');
...
('souffle de la guerisseuse', E'You gain 1 Health Point and draw 1 card. If you control a Breath component, gain 1 HP again.', 'https://magenoir.com/cards/EN/air/Breath.png', 'en', 'Healers Breath');
...
(card_id, description, image_url, locale, "name")
VALUES
('souffle etincelle', E'Inflige 1 point de dégâts à 1 Permanent.Prenez 1 Mana Air dans l''Éther Disponible.', 'https://magenoir.com/cards/FR/Air/Souffle.png', 'fr', 'Souffle Etincelle'),
('souffle etincelle', E'Inflicts 1 damage to 1 Permanent.Take 1 Air Mana from the Available Ether.', 'https://magenoir.com/cards/EN/air/Breath.png', 'en', 'Spark Breath');
...
('millenaire', E'Transmutable : TimeYou cannot control this spell if there are more than 4 cards in your deck.If there are more than 4 cards in your deck while this is in play, discard it right away.Add 10 to every number in the effect of any spell using this as a component.', '', 'en', 'Millennium');
...
(card_id, description, image_url, locale, "name")
VALUES
('anneau d azur', E'Au début de votre tour, choississez 1 option : - Vous gagnez 1 Point de Vie. - Si vous êtes Mage Noir, vous pouvez placer 1 Mana de votre réserve sous 1 sort que vous contrôlez.', '', 'fr', 'Anneau D Azur'),
...
(card_id, description, image_url, locale, "name")
VALUES
('arbre de glace', E'Au début de votre tour, choisissez 1 Permanent ou Équipement : il n''applique pas ses effets jusqu''au début de votre prochain tour.Puis, Arbre de glace perd 1 PV.', '', 'fr', 'Arbre De Glace'),
...
(card_id, description, image_url, locale, "name")
VALUES
('brinicle', E'À la fin du tour de l''adversaire, Brinicle lui inflige 1 point de dégâts par Mana Eau dans sa réserve de Mana.', '', 'fr', 'Brinicle'),
...
(card_id, description, image_url, locale, "name")
VALUES
('condensation', E'Tant que ce sort est en préparation, au début de votre tour, mettez 1 Mana Eau de l''Éther Infini sous ce sort. Lorsque vous l''activez, répartissez la Mana verrouillée sous Condensation entre votre réserve de Mana et vos sorts.', '', 'fr', 'Condensation'),
...
(card_id, description, image_url, locale, "name")
VALUES
('echarde de glace', E'Lent (Ce sort ne peut pas être activé le tour durant lequel il a été préparé )Inflige 2 points de dégâts à n''importe quelle cible.', '', 'fr', 'Echarde De Glace'),
...
(card_id, description, image_url, locale, "name")
VALUES
('engloutissement', E'Détruisez 1 Permanent ou 1 Équipement.', '', 'fr', 'Engloutissement'),
...
(card_id, description, image_url, locale, "name")
VALUES
('ere glaciaire', E'Ne peut être préparé que par un Mage Noir.Vous pouvez préparer ce sort sans le composant Temps requis.Les effets de dégâts de vos sorts Eau sont augmentés de 1.', '', 'fr', 'Ere Glaciaire'),
...
(card_id, description, image_url, locale, "name")
VALUES
('fleche mordante', E'Lent (Ce sort ne peut pas être activé le tour durant lequel il a été préparé )Inflige 1 point de dégâts à n''importe quelle cible.Lorsque ce sort doit aller depuis le plateau vers la défausse, vous pouvez payer 1 Mana Eau pour le renvoyer dans votre main à la place.', '', 'fr', 'Fleche Mordante'),
...
(card_id, description, image_url, locale, "name")
VALUES
('flocon de neige', E'Transmutable : Glace, GoutteMettez 1 Mana Eau verrouillée par ce sort sous un autre sort que vous contrôlez.', '', 'fr', 'Flocon De Neige'),
...
(card_id, description, image_url, locale, "name")
VALUES
('goutte d eau', E'Tant que ce sort est canalisé comme composant, une fois par tour, peut être considéré par un autre sort comme étant 2 composants Goutte. Si vous êtes Mage Noir, compte toujours comme 2 composants Goutte.', '', 'fr', 'Goutte D Eau'),
...
(card_id, description, image_url, locale, "name")
VALUES
('gouttelette', E'Transmutable : Goutte (Ce sort est utilisable comme composant Goutte.)', '', 'fr', 'Gouttelette'),
...
(card_id, description, image_url, locale, "name")
VALUES
('grandes eaux', E'Inflige 1 point de dégâts à n''importe quelle cible par composant Eau actuellement sur le plateau (Permanents et Équipements exclus).', '', 'fr', 'Grandes Eaux'),
...
(card_id, description, image_url, locale, "name")
VALUES
('haute pression', E'Inflige X points de dégâts à n''importe quelle cible. X est égal au nombre de Mana verrouillées sous un composant Condensation que vous contrôlez. Ce composant Condensation retourne dans votre main.', '', 'fr', 'Haute Pression'),
...
(card_id, description, image_url, locale, "name")
VALUES
('hiver percant', E'Pour chaque carte que votre adversaire pioche, cet Équipement lui inflige 1 point de dégâts.Au début de votre tour, Hiver perçant libère 1 Mana Eau.Détruisez cet Équipement dès qu''il ne verrouille plus de Mana Eau.', '', 'fr', 'Hiver Percant'),
...
(card_id, description, image_url, locale, "name")
VALUES
('infiltration glaciale', E'Lent (Ce sort ne peut pas être activé le tour durant lequel il a été préparé )Ce tour-ci, les dégâts des sorts Eau que vous contrôlez sont réduits de 1.Ces dégâts ne peuvent pas être ignorés, réduits, ni redirigés ce tour-ci.', '', 'fr', 'Infiltration Glaciale'),
...
(card_id, description, image_url, locale, "name")
VALUES
('la guerisseuse de l eau', E'La cible de votre choix gagne 3 Points de Vie. Reprenez 1 sort de votre défausse dans votre main.', '', 'fr', 'La Guerisseuse De L Eau'),
...
(card_id, description, image_url, locale, "name")
VALUES
('lances de l hiver', E'Lent (Ce sort ne peut pas être activé le tour durant lequel il a été préparé )Ne peut jamais être Lent tant que vous êtes Mage Noir.Ce sort libère 2 Mana Eau.Inflige 3 points de dégâts à n''importe quelle cible (ou 5 si ce sort verrouille au moins 1 Mana Eau).', '', 'fr', 'Lances De L Hiver'),
...
(card_id, description, image_url, locale, "name")
VALUES
('maelstrom', E'À la fin de leur tour, les joueurs mettent la Mana de leur réserve de Mana dans l''Ether Disponible. Au début de votre tour, détruisez Maelström.', '', 'fr', 'Maelstrom'),
...
(card_id, description, image_url, locale, "name")
VALUES
('maree', E'Piochez 1 carte, puis défaussez-vous d''1 carte en main. Mettez la Mana verrouillée par ce sort sous un autre sort que vous contrôlez. Puis vous pouvez payer 1 Mana Eau pour aller chercher 1 carte Marée dans votre défausse, et la mettre dans votre main.', '', 'fr', 'Maree'),
...
(card_id, description, image_url, locale, "name")
VALUES
('meteore de cristal', E'Inflige 2 points de dégâts à n''importe quelle cible.Les dégâts infligés sont augmentés de 1 par composant Glace que vous contrôlez.', '', 'fr', 'Meteore De Cristal'),
...
(card_id, description, image_url, locale, "name")
VALUES
('mur de glace', E'Ce Permanent a Protecteur tant qu''il verrouille de la Mana Eau.Au début de votre tour, libère 1 Mana Eau.', '', 'fr', 'Mur De Glace'),
...
(card_id, description, image_url, locale, "name")
VALUES
('ocean dechaine', E'Au début de votre tour, vos composants Vague appliquent leurs effets. Puis, ce sort libère 1 Mana Eau pour chaque composant Vague que vous contrôlez. Détruisez ce sort dès qu''il ne verrouille plus de Mana Eau.', '', 'fr', 'Ocean Dechaine'),
...
(card_id, description, image_url, locale, "name")
VALUES
('rituel du zero absolu', E'Vous passez Mage Noir.TOUS les sorts gagnent : "Lent" (Ces sort ne peuvent pas être activés le tour durant lequel ils ont été préparés ).TOUS les sorts peuvent être préparés pour 1 Mana Eau supplémentaire afin qu''ils n''aient pas Lent.', '', 'fr', 'Rituel Du Zero Absolu'),
...
(card_id, description, image_url, locale, "name")
VALUES
('robe de yuki onna', E'Pour chaque carte que votre adversaire pioche, il paye 1 Mana.', '', 'fr', 'Robe De Yuki Onna'),
...
(card_id, description, image_url, locale, "name")
VALUES
('souffle brume', E'Transmutable : Goutte (Ce sort est utilisable comme composant Goutte.) Renvoyez 3 cartes de votre défausse dans votre deck, puis mélangez votre deck.', '', 'fr', 'Souffle Brume'),
...
(card_id, description, image_url, locale, "name")
VALUES
('souffle de glace', E'Jusqu''au début de votre prochain tour, les sorts du joueur ciblé coûtent 1 Mana Eau supplémentaire.', '', 'fr', 'Souffle De Glace'),
...
(card_id, description, image_url, locale, "name")
VALUES
('source prodigieuse', E'Vos composants Eau sont comptés 1 fois de plus (Permanents exclus).', '', 'fr', 'Source Prodigieuse'),
...
(card_id, description, image_url, locale, "name")
VALUES
('tsunami', E'Détruisez tous les Permanents de l''adversaire.Inflige 8 points de dégâts à l''adversaire.', '', 'fr', 'Tsunami'),
...
(card_id, description, image_url, locale, "name")
VALUES
('vague deferlante', E'Inflige 3 points de dégâts à n''importe quelle cible (ou 4 si vous êtes Mage Noir).', '', 'fr', 'Vague Deferlante'),
...
(card_id, description, image_url, locale, "name")
VALUES
('vague echo', E'Applique les effets d''1 composant Vague que vous contrôlez.', '', 'fr', 'Vague Echo'),
...
(card_id, description, image_url, locale, "name")
VALUES
('vague mordante', E'Inflige 2 points de dégâts à n''importe quelle cible.Si vous êtes Mage Noir, verrouillez la Mana Eau de ce sort sous un autre sort que vous contrôlez.', '', 'fr', 'Vague Mordante'),
...
(card_id, description, image_url, locale, "name")
VALUES
('vague purificatrice', E'La cible de votre choix gagne 2 Points de Vie (ou 3 si vous êtes Mage Noir).', '', 'fr', 'Vague Purificatrice'),
...
(card_id, description, image_url, locale, "name")
VALUES
('anneau pourpre', E'Lorsque vous perdez des Points de Vie ou que des dégâts vous sont infligés, vous pouvez payer 1 Mana Feu pour infliger 1 point de dégâts à l''adversaire.', '', 'fr', 'Anneau Pourpre'),
...
(card_id, description, image_url, locale, "name")
VALUES
('aube', E'Tant que ce sort est en préparation, si un Soleil que vous contrôlez devait être détruit, défaussez ce sort à la place.Lorsque vous activez Aube, si vous êtes Mage Noir, piochez 1 carte.', '', 'fr', 'Aube'),
...
(card_id, description, image_url, locale, "name")
VALUES
('boule de feu', E'Vous pouvez défausser 1 carte Feu depuis votre main pour préparer ce sort sans le composant Flamme requis. Inflige 2 points de dégâts à tous les permanents de l''adversaire. Puis inflige 2 points de dégâts à l''adversaire (ou 3 si vous êtes Mage Noir).', '', 'fr', 'Boule De Feu'),
...
(card_id, description, image_url, locale, "name")
VALUES
('brulure solaire', E'Inflige 3 points de dégâts à n''importe quelle cible.Zénith: Défaussez 1 composant que vous contrôlez. Puis infligez 1 point de dégâts à l''adversaire. (Ne s''applique que si vous avez commencé ce tour avec le même nombre de sorts en préparation que de sorts canalisés )', '', 'fr', 'Brulure Solaire'),
...
(card_id, description, image_url, locale, "name")
VALUES
('catalyseur de soleil', E'Unique Zénith : Vos sorts Solaires coûtent 1 Mana Feu de moins à préparer. (Ne s''applique que si vous avez commencé ce tour avec le même nombre de sorts en préparation que de sorts canalisés )', '', 'fr', 'Catalyseur De Soleil'),
...
(card_id, description, image_url, locale, "name")
VALUES
('eblouissement', E'Si vous êtes Mage Noir, vous pouvez préparer ce sort sans le composant Lumière requis.Rapide (Vous pouvez activer ce sort à tout moment )Renvoyez 1 sort en préparation dans la main de son propriétaire.', '', 'fr', 'Eblouissement'),
...
(card_id, description, image_url, locale, "name")
VALUES
('eruption de magma', E'Inflige 7 points de dégâts à n''importe quelle cible.', '', 'fr', 'Eruption De Magma'),
...
(card_id, description, image_url, locale, "name")
VALUES
('eruption solaire', E'Ce tour-ci, préparer les sorts suivants coûte 2 Mana de moins de l''élément du sort : Tornade, Engloutissement, Séisme, Mons Igneus, Maelström, Explosion.Quand vous préparez l''un de ces sorts, piochez une carte.', '', 'fr', 'Eruption Solaire'),
...
(card_id, description, image_url, locale, "name")
VALUES
('explosion solaire', E'Détruisez TOUS les Soleils.Zénith : Inflige 9 points de dégâts à n''importe quelle cible.(Ne s''applique que si vous avez commencé ce tour avec le même nombre de sorts en préparation que de sorts canalisés )', '', 'fr', 'Explosion Solaire'),
...
(card_id, description, image_url, locale, "name")
VALUES
('fission', E'Vous pouvez défausser 1 carte Feu depuis votre main pour préparer ce sort sans le composant Flamme requis. Défaussez-vous d''1 carte en main. Détruisez 1 Permanent.', '', 'fr', 'Fission'),
...
(card_id, description, image_url, locale, "name")
VALUES
('flamme', E'Inflige 1 point de dégâts à n''importe quelle cible. Après que ce sort est utilisé comme composant, défaussez-le.', '', 'fr', 'Flamme'),
('flamme', E'Inflicts 1 damage to any target. After this spell is used as a component, discard it.', 'https://magenoir.com/cards/EN/fire/Draconic-flame.png', 'en', 'Flame');
...
(card_id, description, image_url, locale, "name")
VALUES
('flamme de soufre', E'Ne peut être préparé que par un Mage Noir.Inflige 3 points de dégâts à n''importe quelle cible.', '', 'fr', 'Flamme De Soufre'),
('flamme de soufre', E'Can only be prepared by a Mage Noir.Inflicts 3 damage to any target.', 'https://magenoir.com/cards/EN/fire/Flame.png', 'en', 'Sulfur Flame');
...
(card_id, description, image_url, locale, "name")
VALUES
('flamme draconique', E'Inflige 2 points de dégâts à n''importe quelle cible.Après que ce sort est utilisé comme composant, vous perdez 1 Point de Vie.', '', 'fr', 'Flamme Draconique'),
...
(card_id, description, image_url, locale, "name")
VALUES
('flamme mentale', E'Tant que ce sort est canalisé comme composant :au début de votre tour, payez 1 Mana Feu ou défaussez ce sort.', '', 'fr', 'Flamme Mentale'),
('flamme mentale', E'While channeled as a component:at the start of your turn, pay 1 Fire Mana or discard this spell.', 'https://magenoir.com/cards/EN/fire/Flame.png', 'en', 'Mental Flame');
...
(card_id, description, image_url, locale, "name")
VALUES
('flamme solaire', E'', '', 'fr', 'Flamme Solaire'),
('flamme solaire', E'', 'https://magenoir.com/cards/EN/fire/Flame.png', 'en', 'Solar Flame');
...
(card_id, description, image_url, locale, "name")
VALUES
('fleche ardente', E'Inflige 3 points de dégâts à l''adversaire (ou 4 si vous êtes Mage Noir).', '', 'fr', 'Fleche Ardente'),
...
(card_id, description, image_url, locale, "name")
VALUES
('fouet de feu', E'Au début de votre tour, inflige 1 point de dégâts à l''adversaire (ou 2 si vous êtes Mage Noir).', '', 'fr', 'Fouet De Feu'),
...
(card_id, description, image_url, locale, "name")
VALUES
('ignition', E'Si vous êtes Mage Noir, ce sort coûte 1 Mana Feu de moins à préparer. Ce tour-ci, à chaque fois qu''un sort va depuis le plateau vers la défausse, inflige 1 point de dégâts à l''adversaire.', '', 'fr', 'Ignition'),
...
(card_id, description, image_url, locale, "name")
VALUES
('invocation solaire', E'Si le sort du dessus de votre défausse est canalisable, mettez-le en jeu, canalisé comme composant (Équipements, Permanent, et Rituels ne sont pas canalisables). Zénith : inflige 2 points de dégâts à n''importe quelle cible.(Ne s''applique que si vous avez commencé ce tour avec le même nombre de sorts en préparation que de sorts canalisés )', '', 'fr', 'Invocation Solaire'),
...
(card_id, description, image_url, locale, "name")
VALUES
('lame du soleil', E'Au début de votre tour, libère 1 Mana Feu.Dès que Lame du soleil ne verrouille plus de Mana Feu, elle inflige 5 points de dégâts à TOUS les joueurs, puis elle est détruite.', '', 'fr', 'Lame Du Soleil'),
...
(card_id, description, image_url, locale, "name")
VALUES
('lumiere radieuse', E'Regardez la carte du dessus de votre deck.Vous pouvez la laisser au-dessus, ou la mettre en dessous de votre deck.Puis piochez 1 carte.', '', 'fr', 'Lumiere Radieuse'),
...
(card_id, description, image_url, locale, "name")
VALUES
('masque de feu', E'A tout moment, vous pouvez regarder la carte du dessus de votre deck. Les composants nécessaires plusieurs fois pour préparer vos sorts Feu sont nécessaires 1 fois de moins.', '', 'fr', 'Masque De Feu'),
...
(card_id, description, image_url, locale, "name")
VALUES
('minerai d or solaire', E'ForgeZénith : Indestructible (Ne s''applique que si vous avez commencé ce tour avec le même nombre de sorts en préparation que de sorts canalisés )Tout Équipement qui utilise ce sort comme composant gagne les effets de Minerai d''or solaire.', '', 'fr', 'Minerai D Or Solaire'),
...
(card_id, description, image_url, locale, "name")
VALUES
('pluie de flammes', E'Ne peut être préparé que par un Mage Noir.Inflige 5 points de dégâts, répartis comme vous le souhaitez entre 1 à 5 cibles.', '', 'fr', 'Pluie De Flammes'),
('pluie de flammes', E'Can only be prepared by a Mage Noir.Inflicts 5 damage distributed as you choose between 1 to 5 targets.', 'https://magenoir.com/cards/EN/fire/Flame.png', 'en', 'Rain Of Flames');
...
(card_id, description, image_url, locale, "name")
VALUES
('projectile de flamme', E'Inflige 3 points de dégâts à n''importe quelle cible.', '', 'fr', 'Projectile De Flamme'),
...
(card_id, description, image_url, locale, "name")
VALUES
('rayon de lumiere', E'Le prochain sort Végétal que vous préparez ce tour-ci coûte 2 Mana Végétal de moins.Si c''est un Permanent avec PV, il arrive en jeu avec 1 PV supplémentaire.', '', 'fr', 'Rayon De Lumiere'),
...
(card_id, description, image_url, locale, "name")
VALUES
('rituel du zenith', E'Vous passez Mage Noir.Chaque fois qu''un sort que vous contrôlez est canalisé, payez 1 Mana Feu.Zénith : Durant votre phase principale, vous pouvez payer 1 Mana Feu pour activer 1 de vos sorts canalisés. (Ne s''applique que si vous avez commencé ce tour avec le même nombre de sorts en préparation que de sorts canalisés )', '', 'fr', 'Rituel Du Zenith'),
...
(card_id, description, image_url, locale, "name")
VALUES
('robe brulante', E'Chaque fois qu''un sort Feu que vous contrôlez inflige des dégâts à une cible adverse, ils sont augmentés de 1 (ou 2 si vous êtes Mage Noir). Puis, Robe brûlante vous inflige 1 point de dégâts.', '', 'fr', 'Robe Brulante'),
...
(card_id, description, image_url, locale, "name")
VALUES
('soleil artificiel', E'Au début de votre tour, Soleil artificiel inflige 1 point de dégâts à TOUS les joueurs. Puis payez 1 Mana Feu ou détruisez Soleil artificiel.', '', 'fr', 'Soleil Artificiel'),
...
(card_id, description, image_url, locale, "name")
VALUES
('vague de flammes', E'Inflige 1 point de dégâts à l''adversaire et ses Permanents par composant Flamme que vous contrôlez.', '', 'fr', 'Vague De Flammes'),
('vague de flammes', E'Inflicts 1 damage to the opponent and their Permanents for each Flame component you control.', 'https://magenoir.com/cards/EN/fire/Flame.png', 'en', 'Wave Of Flames');
...
(card_id, description, image_url, locale, "name")
VALUES
('vents solaires', E'Inflige 3 points de dégâts à n''importe quelle cible.Zénith : Piochez 1 carte.(Ne s''applique que si vous avez commencé ce tour avec le même nombre de sorts en préparation que de sorts canalisés )', '', 'fr', 'Vents Solaires'),
...
(card_id, description, image_url, locale, "name")
VALUES
('epee materialisee', E'Une fois par tour, durant votre phase principale, inflige 2 points de dégâts à n''importe quelle cible. Puis la Lame utilisée comme composant pour lancer ce sort applique ses effets (même si celle-ci est dans la défausse).', '', 'fr', 'Epee Materialisee'),
...
(card_id, description, image_url, locale, "name")
VALUES
('roche', E'Si vous contrôlez 2 exemplaires de ce sort, ils ont "Transmutable : Minerai". Forge. (Est défaussé lorsqu''utilisé comme composant pour un Équipement.) Prenez 1 Mana Minéral dans l''Ether disponible puis infligez 1 point de dégât à 1 Permanent.', 'https://magenoir.com/cards/FR/Mineral/Mur-de-roche.png', 'fr', 'Roche'),
...
('roche ferreuse', E'During your main phase, you may put 1 Fire Mana from your Mana reserve under this spell. Then, it gains "Transmutable : Ore" (This spell can be used as an Ore component.). Forge.(Is discarded once used as a component for Equipment.)', 'https://magenoir.com/cards/EN/mineral/Iron-rock.png', 'en', 'Iron Rock');
...
(card_id, description, image_url, locale, "name")
VALUES
('roche friable', E'Durant votre phase principale, vous pouvez payer 1 Mana Minéral pour que ce sort gagne "Transmutable : Sable" jusqu''à la fin du tour.Lorsque vous activez Roche friable, inflige 1 point de dégâts à n''importe quelle cible.', 'https://magenoir.com/cards/FR/Mineral/Roche.png', 'fr', 'Roche Friable'),
...
('fleur de kerloc h', E'Unique, unless you''re a Mage Noir.At the beginning of your turn, inflicts 2 damage to the opponent, then this Permanent gains 1 HP (or 2 if you control at least 4 Drop components).', '', 'en', 'Kerloc H S Flower');
...
(card_id, description, image_url, locale, "name")
VALUES
('graine', E'Vous gagnez 1 Point de Vie.', 'https://magenoir.com/cards/FR/Vegetal/Graine-germee.png', 'fr', 'Graine'),
...
(card_id, description, image_url, locale, "name")
VALUES
('graine bourgeonnante', E'Lent (Ce sort ne peut pas être activé le tour durant lequel il a été préparé )Allez chercher 1 carte Fleur dans votre deck, montrez-la à votre adversaire, mettez-la dans votre main, puis mélangez votre deck.', 'https://magenoir.com/cards/FR/Vegetal/Graine.png', 'fr', 'Graine Bourgeonnante'),
('graine bourgeonnante', E'Slowcast (This spell can''t be activated on the turn it was prepared) Take 1 Flower card from your deck, show it to the opponent, put it into your hand and shuffle your deck.', 'https://magenoir.com/cards/EN/vegetal/Seed.png', 'en', 'Budding Seed');
...
('graine germee', E'Transmutable : Drop (This spell can be used as a Drop component.)Take 1 Tree card from your deck, show it to the opponent, put it into your hand and shuffle your deck.', 'https://magenoir.com/cards/EN/vegetal/Seed.png', 'en', 'Sprouted Seed');
