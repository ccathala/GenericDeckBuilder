...
VALUES
('acceleration', E'Si vous êtes Mage Noir, ce sort coûte 1 Mana Arcane de moins à préparer.Piochez 2 cartes.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Air/Acceleration.png', 'fr', 'Acceleration'),
...
(card_id, description, image_url, locale, "name")
VALUES
('eclair d inspiration', E'Piochez 1 carte.Piochez 1 carte supplémentaire pour chaque composant Inspiration que vous contrôlez.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Air/eclair_d_inspiration.png', 'fr', 'Eclair D Inspiration'),
...
(card_id, description, image_url, locale, "name")
VALUES
('etincelle electrique', E'Inflige 1 point de dégâts à l''adversaire.Piochez 1 carte.Défaussez-vous d''1 carte en main.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Air/etincelle_electrique.png', 'fr', 'Etincelle Electrique'),
...
(card_id, description, image_url, locale, "name")
VALUES
('etincelle statique', E'Lorsque ce sort est défaussé depuis votre main, il applique ses effets.Inflige 1 point de dégâts à n''importe quelle cible.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Air/etincelle_statique.png', 'fr', 'Etincelle Statique'),
...
('robe du hurleur', E'Can only be prepared by a Mage Noir Air spells you prepare cost 1 less Air Mana. Damage from Air spells you control is increased by 1.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/EN/air/Howlers-robe.png', 'en', 'Howlers Robe');
...
(card_id, description, image_url, locale, "name")
VALUES
('souffle de la guerisseuse', E'Vous gagnez 1 Point de Vie puis piochez 1 carte. Si vous contrôlez un composant Souffle, gagnez à nouveau 1 Point de Vie.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Air/Souffle-de-la-guerisseuse.png', 'fr', 'Souffle De La Guerisseuse'),
('souffle de la guerisseuse', E'You gain 1 Health Point and draw 1 card. If you control a Breath component, gain 1 HP again.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/EN/air/Healers-breath.png', 'en', 'Healers Breath');
...
(card_id, description, image_url, locale, "name")
VALUES
('souffle etincelle', E'Inflige 1 point de dégâts à 1 Permanent.Prenez 1 Mana Air dans l''Éther Disponible.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Air/souffle_etincelle.png', 'fr', 'Souffle Etincelle'),
...
('vent tourbillonnant', E'Return 1 prepared spell on top of its owner''s deck.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/EN/air/Whirling-wind.png', 'en', 'Whirling Wind');
...
(card_id, description, image_url, locale, "name")
VALUES
('zephyr', E'Inflige 2 points de dégâts à n''importe quelle cible.Piochez 1 carte.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Air/Zephyr.png', 'fr', 'Zephyr'),
...
(card_id, description, image_url, locale, "name")
VALUES
('acceleration du temps', E'Tout sort utilisant ce sort comme composant gagne l''effet : "Défaussez 1 carte du dessus de votre deck."', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Arcane/Acceleration-du-temps.png', 'fr', 'Acceleration Du Temps'),
...
(card_id, description, image_url, locale, "name")
VALUES
('acceleration forcee', E'Votre adversaire pioche 7 cartes (ou 3 s''il est Mage Noir).', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Arcane/acceleration_forcee.png', 'fr', 'Acceleration Forcee'),
...
(card_id, description, image_url, locale, "name")
VALUES
('alteration du passe', E'Échangez les positions de deux sorts dans la défausse du joueur de votre choix.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Arcane/alteration_du_passe.png', 'fr', 'Alteration Du Passe'),
...
(card_id, description, image_url, locale, "name")
VALUES
('antimatiere', E'Payez le coût en Mana d''1 Permanent pour le détruire.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Arcane/antimatiere.png', 'fr', 'Antimatiere'),
...
(card_id, description, image_url, locale, "name")
VALUES
('apercu du futur', E'Déphase 1 le joueur de votre choix (Défausse 1 carte du dessous de son deck).Puis ce joueur pioche 1 carte.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Arcane/apercu_du_futur.png', 'fr', 'Apercu Du Futur'),
...
(card_id, description, image_url, locale, "name")
VALUES
('destin differe', E'Vous pouvez utiliser 1 composant Temps supplémentaire pour le prochain sort que vous préparez ce tour-ci.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Arcane/Destin-differe.png', 'fr', 'Destin Differe'),
...
(card_id, description, image_url, locale, "name")
VALUES
('millenaire', E'Transmutable : TempsVous ne pouvez pas contrôler ce sort si votre deck contient plus de 4 cartes. Si votre deck contient plus de 4 cartes tandis que Millénaire est en jeu, défaussez-le.Ajoutez 10 à chaque nombre présent dans l''effet de tout sort utilisant ce composant.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Arcane/millenaire.png', 'fr', 'Millenaire'),
...
(card_id, description, image_url, locale, "name")
VALUES
('rappel au present', E'Inflige 1 point de dégâts à n''importe quelle cible pour chaque composant Temps dans votre défausse. Défaussez TOUS les sorts en jeu ne verrouillant aucune Mana.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Arcane/Rappel-au-present.png', 'fr', 'Rappel Au Present'),
...
(card_id, description, image_url, locale, "name")
VALUES
('reflexion abstruse', E'Déphase 0 l''adversaire. (Défausse 0 cartes du dessous de son deck )Déphase 0 l''adversaire. (Défausse 0 cartes du dessous de son deck )', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Arcane/reflexion_abstruse.png', 'fr', 'Reflexion Abstruse'),
...
(card_id, description, image_url, locale, "name")
VALUES
('revocation', E'Ne peut être préparé que par un Mage Noir.Rapide (Ce sort peut être activé à tout moment)Défaussez 1 sort en préparation.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Arcane/revocation.png', 'fr', 'Revocation'),
...
(card_id, description, image_url, locale, "name")
VALUES
('siecle', E'Transmutable : Temps (Ce sort est utilisable comme composant Temps.) Après que ce sort est utilisé comme composant, défaussez-le. Doublez chaque chiffre présent dans l''effet de tout sort utilisant ce composant.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Arcane/Siecle.png', 'fr', 'Siecle'),
...
('suppression dimensionnelle', E'Discard 1 prepared spell.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/EN/arcane/dimensional-deletion.png', 'en', 'Dimensional Deletion');
...
(card_id, description, image_url, locale, "name")
VALUES
('temps destructure', E'Tout sort utilisant ce sort comme composant gagne l''effet :"Déphase 1 l''adversaire (Défausse 1 carte du dessous de son deck )"', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Arcane/temps_destructure.png', 'fr', 'Temps Destructure'),
...
('brinicle', E'At the end of the opponent''s turn, Brinicle inflicts 1 damage to them for each Water Mana in their Mana reserve.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/EN/water/brinicle.png', 'en', 'Brinicle');
...
(card_id, description, image_url, locale, "name")
VALUES
('echarde de glace', E'Lent (Ce sort ne peut pas être activé le tour durant lequel il a été préparé )Inflige 2 points de dégâts à n''importe quelle cible.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Eau/echarde_de_glace.png', 'fr', 'Echarde De Glace'),
...
(card_id, description, image_url, locale, "name")
VALUES
('ere glaciaire', E'Ne peut être préparé que par un Mage Noir.Vous pouvez préparer ce sort sans le composant Temps requis.Les effets de dégâts de vos sorts Eau sont augmentés de 1.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Eau/ere_glaciaire.png', 'fr', 'Ere Glaciaire'),
...
(card_id, description, image_url, locale, "name")
VALUES
('hiver percant', E'Pour chaque carte que votre adversaire pioche, cet Équipement lui inflige 1 point de dégâts.Au début de votre tour, Hiver perçant libère 1 Mana Eau.Détruisez cet Équipement dès qu''il ne verrouille plus de Mana Eau.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Eau/hiver_percant.png', 'fr', 'Hiver Percant'),
...
(card_id, description, image_url, locale, "name")
VALUES
('la guerisseuse de l eau', E'La cible de votre choix gagne 3 Points de Vie. Reprenez 1 sort de votre défausse dans votre main.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Eau/La-guerisseuse-de-l-eau.png', 'fr', 'La Guerisseuse De L Eau'),
...
(card_id, description, image_url, locale, "name")
VALUES
('maelstrom', E'À la fin de leur tour, les joueurs mettent la Mana de leur réserve de Mana dans l''Ether Disponible. Au début de votre tour, détruisez Maelström.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Eau/Maelstrom.png', 'fr', 'Maelstrom'),
('maelstrom', E'At the end of their turns, players put all the Mana from their Mana reserve into the Available Ether. At the beginning of your turn, destroy Maelström.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/EN/water/Maelstrom.png', 'en', 'Maelstrom');
...
(card_id, description, image_url, locale, "name")
VALUES
('meteore de cristal', E'Inflige 2 points de dégâts à n''importe quelle cible.Les dégâts infligés sont augmentés de 1 par composant Glace que vous contrôlez.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Eau/meteore_de_cristal.png', 'fr', 'Meteore De Cristal'),
...
(card_id, description, image_url, locale, "name")
VALUES
('ocean dechaine', E'Au début de votre tour, vos composants Vague appliquent leurs effets. Puis, ce sort libère 1 Mana Eau pour chaque composant Vague que vous contrôlez. Détruisez ce sort dès qu''il ne verrouille plus de Mana Eau.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Eau/Ocean-dechaine.png', 'fr', 'Ocean Dechaine'),
...
(card_id, description, image_url, locale, "name")
VALUES
('rituel du melange', E'Vous passez Mage Noir. Lorsque vous ajoutez de la Mana à l''Éther disponible durant votre phase de récupération de Mana, ajoutez 1 Mana de moins. Durant votre phase principale, vous pouvez échanger la Mana verrouillée sous vos sorts Eau et celle de votre réserve de Mana à 1 pour 1.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Eau/Rituel-du-melange.png', 'fr', 'Rituel Du Melange'),
('rituel du melange', E'You become a Mage Noir. When you add Mana to the Available Ether during your Mana gathering phase, add 1 less Mana. During your main phase, you may trade Mana between your Mana reserve and your Water spells at a rate of 1 for 1.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/EN/water/Ritual-of-melange.png', 'en', 'Ritual Of Melange');
...
(card_id, description, image_url, locale, "name")
VALUES
('vague deferlante', E'Inflige 3 points de dégâts à n''importe quelle cible (ou 4 si vous êtes Mage Noir).', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Eau/Vague-deferlante.png', 'fr', 'Vague Deferlante'),
...
(card_id, description, image_url, locale, "name")
VALUES
('vague echo', E'Applique les effets d''1 composant Vague que vous contrôlez.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Eau/Vague-echo.png', 'fr', 'Vague Echo'),
...
(card_id, description, image_url, locale, "name")
VALUES
('brulure solaire', E'Inflige 3 points de dégâts à n''importe quelle cible.Zénith: Défaussez 1 composant que vous contrôlez. Puis infligez 1 point de dégâts à l''adversaire. (Ne s''applique que si vous avez commencé ce tour avec le même nombre de sorts en préparation que de sorts canalisés )', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Feu/brulure_solaire.png', 'fr', 'Brulure Solaire'),
...
(card_id, description, image_url, locale, "name")
VALUES
('eblouissement', E'Si vous êtes Mage Noir, vous pouvez préparer ce sort sans le composant Lumière requis.Rapide (Vous pouvez activer ce sort à tout moment )Renvoyez 1 sort en préparation dans la main de son propriétaire.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Feu/eblouissement.png', 'fr', 'Eblouissement'),
...
(card_id, description, image_url, locale, "name")
VALUES
('eruption de magma', E'Inflige 7 points de dégâts à n''importe quelle cible.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Feu/Magma-eruption.png', 'fr', 'Eruption De Magma'),
...
(card_id, description, image_url, locale, "name")
VALUES
('flamme solaire', E'', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Feu/flamme_solaire.png', 'fr', 'Flamme Solaire'),
('flamme solaire', E'', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/EN/fire/solar_flame.png', 'en', 'Solar Flame');
...
(card_id, description, image_url, locale, "name")
VALUES
('fleche ardente', E'Inflige 3 points de dégâts à l''adversaire (ou 4 si vous êtes Mage Noir).', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Feu/Fleche-ardente.png', 'fr', 'Fleche Ardente'),
...
(card_id, description, image_url, locale, "name")
VALUES
('lumiere radieuse', E'Regardez la carte du dessus de votre deck.Vous pouvez la laisser au-dessus, ou la mettre en dessous de votre deck.Puis piochez 1 carte.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Feu/lumiere_radieuse.png', 'fr', 'Lumiere Radieuse'),
...
(card_id, description, image_url, locale, "name")
VALUES
('rayon de lumiere', E'Le prochain sort Végétal que vous préparez ce tour-ci coûte 2 Mana Végétal de moins.Si c''est un Permanent avec PV, il arrive en jeu avec 1 PV supplémentaire.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Feu/rayon_de_lumiere.png', 'fr', 'Rayon De Lumiere'),
...
(card_id, description, image_url, locale, "name")
VALUES
('rituel du zenith', E'Vous passez Mage Noir.Chaque fois qu''un sort que vous contrôlez est canalisé, payez 1 Mana Feu.Zénith : Durant votre phase principale, vous pouvez payer 1 Mana Feu pour activer 1 de vos sorts canalisés. (Ne s''applique que si vous avez commencé ce tour avec le même nombre de sorts en préparation que de sorts canalisés )', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Feu/rituel_du_zenith.png', 'fr', 'Rituel Du Zenith'),
...
(card_id, description, image_url, locale, "name")
VALUES
('armure materialisee', E'Les dégâts que vous subissez sont réduits de 1. Chaque tour, ignorez jusqu''à X point de dégâts qui vous sont infligés. X est égal au nombre de Mana Minéral sous vos autres composants. X est déterminé la première fois que des dégâts vous sont infligés dans le tour. X ne peut être supérieur à 6', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Mineral/Armure-materialisee.png', 'fr', 'Armure Materialisee'),
...
(card_id, description, image_url, locale, "name")
VALUES
('brulure de magma', E'Inflige 5 points de dégâts à n''importe quelle cible. Vous pouvez détruire 1 Anneau.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Mineral/Brulure-de-magma.png', 'fr', 'Brulure De Magma'),
...
(card_id, description, image_url, locale, "name")
VALUES
('colere de ra', E'Mettez 1 sort en jeu (hors Rituel) dans la défausse de son contrôleur. Si vous êtes Mage Noir, cet effet ignore Indestructible.Inflige 5 points de dégâts à l''adversaire.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Mineral/colere_de_ra.png', 'fr', 'Colere De Ra'),
('colere de ra', E'Put any 1 spell in play (except a Ritual) into its owner''s discard pile. If you''re a Mage Noir, this ignores Indestructible.Inflicts 5 damage to the opponent.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/EN/mineral/ra_s_wrath.png', 'en', 'Ra S Wrath');
...
(card_id, description, image_url, locale, "name")
VALUES
('epee materialisee', E'Une fois par tour, durant votre phase principale, inflige 2 points de dégâts à n''importe quelle cible. Puis la Lame utilisée comme composant pour lancer ce sort applique ses effets (même si celle-ci est dans la défausse).', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Mineral/Lame-materialisee.png', 'fr', 'Epee Materialisee'),
...
(card_id, description, image_url, locale, "name")
VALUES
('lame forgee', E'Une fois par tour, durant votre phase principale, inflige 1 point de dégât à n''importe quelle cible.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Mineral/Lame-forgee.png', 'fr', 'Lame Forgee'),
...
(card_id, description, image_url, locale, "name")
VALUES
('main du desert', E'Au début de votre tour, inflige 1 point de dégâts à l''adversaire.Si vous contrôlez au moins 2 composants Sable, ce Permanent a Protecteur.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Mineral/main_du_desert.png', 'fr', 'Main Du Desert'),
...
(card_id, description, image_url, locale, "name")
VALUES
('meteore d ina', E'Si vous êtes Mage Noir, pour préparer ce sort, vous pouvez utiliser 4 roches au lieu d''1 composant Météore. Inflige X points de dégâts à n''importe quelle cible.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Mineral/Meteore-d-ina.png', 'fr', 'Meteore D Ina'),
('meteore d ina', E'If you''re a Mage Noir, you may use 4 Rocks instead of 1 Meteor component to prepare this spell. Inflicts X damage to any target.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/EN/mineral/Inas-meteor.png', 'en', 'Inas Meteor');
...
(card_id, description, image_url, locale, "name")
VALUES
('meteore du desert', E'Si vous êtes Mage Noir, ce sort coûte 1 Mana Minéral de moins à préparer.Inflige 1 point de dégâts à n''importe quelle cible par composant Sable que vous contrôlez.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Mineral/meteore_du_desert.png', 'fr', 'Meteore Du Desert'),
...
(card_id, description, image_url, locale, "name")
VALUES
('mur du desert', E'Lorsqu''il arrive en jeu, déplacez autant de Mana Minéral que vous le souhaitez de vos composants Sable sous ce Permanent.Mur du désert arrive en jeu avec autant de PV qu''il verrouille de Mana Minéral.Si vous êtes Mage Noir, ce Permanent a Protecteur.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Mineral/mur_du_desert.png', 'fr', 'Mur Du Desert'),
...
(card_id, description, image_url, locale, "name")
VALUES
('poing meteore', E'Inflige 5 points de dégâts à l''adversaire. Puis vous inflige 2 points de dégâts. Puis inflige 2 points de dégâts à TOUS les Permanents.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Mineral/Poing-meteore.png', 'fr', 'Poing Meteore'),
...
(card_id, description, image_url, locale, "name")
VALUES
('seisme', E'Inflige 4 points de dégâts à l''adversaire. Si vous êtes Mage Noir, détruisez TOUS les Permanents.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Mineral/Seisme.png', 'fr', 'Seisme'),
...
(card_id, description, image_url, locale, "name")
VALUES
('volee aiguisee', E'Vous inflige 1 point de dégâts 5 fois, à moins que vous ne soyez Mage Noir. Inflige 1 point de dégâts à l''adversaire 5 fois.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Mineral/Volee-aiguisee.png', 'fr', 'Volee Aiguisee'),
...
(card_id, description, image_url, locale, "name")
VALUES
('armure d ecorce', E'Chaque tour, ignorez jusqu''à 1 point de dégâts adverses qui vous sont infligés.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Vegetal/Armure-d-ecorce.png', 'fr', 'Armure D Ecorce'),
...
(card_id, description, image_url, locale, "name")
VALUES
('distillation de seve', E'Prenez 3 Mana de votre choix dans l''Éther Infini (ou 4 si vous êtes Mage Noir).', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Vegetal/distillation_de_seve.png', 'fr', 'Distillation De Seve'),
...
(card_id, description, image_url, locale, "name")
VALUES
('floraison letale', E'Lent (Ce sort ne peut pas être activé le tour durant lequel il a été préparé )L''adversaire perd 5 PV.Défaussez 1 composant Fleur que vous contrôlez.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Vegetal/floraison_letale.png', 'fr', 'Floraison Letale'),
...
(card_id, description, image_url, locale, "name")
VALUES
('foret enchantee', E'Au début de votre tour, vous et vos Permanents Végétaux qui ont des Points de Vie gagnez 2 Points de Vie.Protecteur (Vous pouvez rediriger les dégâts adverses sur ce Permanent.)', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Vegetal/Foret-enchantee.png', 'fr', 'Foret Enchantee'),
...
(card_id, description, image_url, locale, "name")
VALUES
('la guerisseuse sylvestre', E'Choisissez 1 option :- Le Permanent Végétal avec des Points de Vie ciblé gagne 4 Points de Vie.- Vous gagnez 3 Points de Vie.', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Vegetal/La-guerisseuse-sylvestre.png', 'fr', 'La Guerisseuse Sylvestre'),
...
(card_id, description, image_url, locale, "name")
VALUES
('petales tranchants', E'Inflige 3 points de dégâts à n''importe quelle cible.Inflige 2 points de dégâts à un Permanent Végétal que vous contrôlez (ou 1 si vous êtes Mage Noir).', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Vegetal/petales_tranchants.png', 'fr', 'Petales Tranchants'),
...
(card_id, description, image_url, locale, "name")
VALUES
('ronces ephemeres', E'L''adversaire choisit 1 option :- Il défausse 1 carte de sa main- Il perd 3 Points de Vie', 'https://cdn.jsdelivr.net/gh/ccathala/mndb-images@main/cards/FR/Vegetal/Ronces-ephemeres.png', 'fr', 'Ronces Ephemeres'),
